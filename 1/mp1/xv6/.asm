...
void fib(void *arg) {
  ...
  12:	d0278793          	addi	a5,a5,-766 # d10 <cnt>
  16:	4390                	lw	a2,0(a5)
  ...
  36:	c8e50513          	addi	a0,a0,-882 # cc0 <thread_assign_task+0x4a>
  ...
  68:	cb490913          	addi	s2,s2,-844 # d18 <t>
  ...
  7e:	bfc080e7          	jalr	-1028(ra) # c76 <thread_assign_task>
...
int main(int argc, char **argv) {
  ...
  cc:	c0850513          	addi	a0,a0,-1016 # cd0 <thread_assign_task+0x5a>
  ...
  f0:	c2a7b623          	sd	a0,-980(a5) # d18 <t>
 ...
 100:	b4e080e7          	jalr	-1202(ra) # c4a <thread_start_threading>
    }
    printf("\nexited\n");
 104:	00001517          	auipc	a0,0x1
 108:	bdc50513          	addi	a0,a0,-1060 # ce0 <thread_assign_task+0x6a>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 47c:	88050513          	addi	a0,a0,-1920 # cf8 <digits>
 480:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 548:	7b4b8b93          	addi	s7,s7,1972 # cf8 <digits>
 ...
 688:	66c90913          	addi	s2,s2,1644 # cf0 <thread_assign_task+0x7a>
        while(*s != 0){
...
free(void *ap)
{
 ...
 750:	5d47b783          	ld	a5,1492(a5) # d20 <freep>
 ...
 77e:	00e6ea63          	bltu	a3,a4,792 <free+0x50>
{
 ...
 7c0:	56f73223          	sd	a5,1380(a4) # d20 <freep>
}
 7c4:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7f2:	53253503          	ld	a0,1330(a0) # d20 <freep>
 ...
 81a:	50a90913          	addi	s2,s2,1290 # d20 <freep>
  if(p == (char*)-1)
 81e:	5afd                	li	s5,-1
 820:	a88d                	j	892 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 822:	00000797          	auipc	a5,0x0
 826:	51678793          	addi	a5,a5,1302 # d38 <base>
 82a:	00000717          	auipc	a4,0x0
 82e:	4ef73b23          	sd	a5,1270(a4) # d20 <freep>
 832:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 854:	4ca73823          	sd	a0,1232(a4) # d20 <freep>
      return (void*)(p + 1);
...
struct thread *thread_create(void (*f)(void *), void *arg){
 ...
 95e:	3b270713          	addi	a4,a4,946 # d0c <id>
 962:	431c                	lw	a5,0(a4)
...
void thread_add_runqueue(struct thread *t){
 ...
 996:	39e7b783          	ld	a5,926(a5) # d30 <current_thread>
 99a:	cb91                	beqz	a5,9ae <thread_add_runqueue+0x22>
        current_thread = t;
 ...
 9a0:	f15c                	sd	a5,160(a0)
        current_thread->previous->next = t;
 9a2:	6fd8                	ld	a4,152(a5)
 9a4:	f348                	sd	a0,160(a4)
        current_thread->previous = t;
 9a6:	efc8                	sd	a0,152(a5)
    }
}
 9a8:	6422                	ld	s0,8(sp)
 ...
 9b2:	38a7b123          	sd	a0,898(a5) # d30 <current_thread>
        current_thread->previous = t;
 9b6:	ed48                	sd	a0,152(a0)
        current_thread->next = t;
 9b8:	f148                	sd	a0,160(a0)
 9ba:	b7fd                	j	9a8 <thread_add_runqueue+0x1c>

00000000000009bc <schedule>:
            thread_exit();
        }
    }
...
void schedule(void){
 ...
 9c6:	36e78793          	addi	a5,a5,878 # d30 <current_thread>
 9ca:	6398                	ld	a4,0(a5)
 9cc:	7358                	ld	a4,160(a4)
 9ce:	e398                	sd	a4,0(a5)
}
 9d0:	6422                	ld	s0,8(sp)
...
void thread_exit(void){
 ...
 9e2:	00000497          	auipc	s1,0x0
 9e6:	34e4b483          	ld	s1,846(s1) # d30 <current_thread>
 9ea:	74c8                	ld	a0,168(s1)
 9ec:	cd19                	beqz	a0,a0a <thread_exit+0x34>
 9ee:	00000917          	auipc	s2,0x0
 9f2:	34290913          	addi	s2,s2,834 # d30 <current_thread>
        struct task *tail = latest_task;
        latest_task = latest_task->previous;
 9f6:	691c                	ld	a5,16(a0)
 9f8:	f4dc                	sd	a5,168(s1)
        free(tail);
 9fa:	00000097          	auipc	ra,0x0
 9fe:	d48080e7          	jalr	-696(ra) # 742 <free>
    while(latest_task != NULL){
 a02:	00093483          	ld	s1,0(s2)
 a06:	74c8                	ld	a0,168(s1)
 a08:	f57d                	bnez	a0,9f6 <thread_exit+0x20>
    }

    if(current_thread->next != current_thread){
 a0a:	70dc                	ld	a5,160(s1)
 a0c:	02978e63          	beq	a5,s1,a48 <thread_exit+0x72>
        current_thread->previous->next = current_thread->next;
 a10:	6cd8                	ld	a4,152(s1)
 a12:	f35c                	sd	a5,160(a4)
        current_thread->next->previous = current_thread->previous;
 a14:	6cd8                	ld	a4,152(s1)
 a16:	efd8                	sd	a4,152(a5)
        struct thread *tmp = current_thread;
        schedule();
 a18:	00000097          	auipc	ra,0x0
 a1c:	fa4080e7          	jalr	-92(ra) # 9bc <schedule>

        free(tmp->stack);
 a20:	6888                	ld	a0,16(s1)
 a22:	00000097          	auipc	ra,0x0
 a26:	d20080e7          	jalr	-736(ra) # 742 <free>
        free(tmp);
 a2a:	8526                	mv	a0,s1
 a2c:	00000097          	auipc	ra,0x0
 a30:	d16080e7          	jalr	-746(ra) # 742 <free>

        dispatch();
 a34:	00000097          	auipc	ra,0x0
 a38:	048080e7          	jalr	72(ra) # a7c <dispatch>
        free(current_thread);
        current_thread = NULL;
 ...
 a48:	6888                	ld	a0,16(s1)
 a4a:	00000097          	auipc	ra,0x0
 a4e:	cf8080e7          	jalr	-776(ra) # 742 <free>
        free(current_thread);
 a52:	00000497          	auipc	s1,0x0
 a56:	2de48493          	addi	s1,s1,734 # d30 <current_thread>
 a5a:	6088                	ld	a0,0(s1)
 a5c:	00000097          	auipc	ra,0x0
 a60:	ce6080e7          	jalr	-794(ra) # 742 <free>
        current_thread = NULL;
 a64:	0004b023          	sd	zero,0(s1)
        longjmp(env_st, 1);
 a68:	4585                	li	a1,1
 a6a:	00000517          	auipc	a0,0x0
 a6e:	2de50513          	addi	a0,a0,734 # d48 <env_st>
 a72:	00000097          	auipc	ra,0x0
 a76:	e74080e7          	jalr	-396(ra) # 8e6 <longjmp>
}
 a7a:	b7c9                	j	a3c <thread_exit+0x66>

0000000000000a7c <dispatch>:
void dispatch(void){
 ...
 a8a:	2aa78793          	addi	a5,a5,682 # d30 <current_thread>
 a8e:	639c                	ld	a5,0(a5)
 a90:	77c8                	ld	a0,168(a5)
 a92:	c561                	beqz	a0,b5a <dispatch+0xde>
        current_task = latest_task;
 a94:	00000797          	auipc	a5,0x0
 a98:	29478793          	addi	a5,a5,660 # d28 <current_task>
 a9c:	e388                	sd	a0,0(a5)
        if(current_task->task_buf_set == 0){
 a9e:	09052783          	lw	a5,144(a0)
 aa2:	e7c5                	bnez	a5,b4a <dispatch+0xce>
            if(setjmp(current_task->task_env) == 0){
 aa4:	02050513          	addi	a0,a0,32
 aa8:	00000097          	auipc	ra,0x0
 aac:	e06080e7          	jalr	-506(ra) # 8ae <setjmp>
 ab0:	c13d                	beqz	a0,b16 <dispatch+0x9a>
                current_task->fp(current_task->arg);
 ab2:	00000497          	auipc	s1,0x0
 ab6:	27648493          	addi	s1,s1,630 # d28 <current_task>
 aba:	609c                	ld	a5,0(s1)
 abc:	6398                	ld	a4,0(a5)
 abe:	6788                	ld	a0,8(a5)
 ac0:	9702                	jalr	a4
 ...
 ac2:	6088                	ld	a0,0(s1)
 ac4:	691c                	ld	a5,16(a0)
 ac6:	c399                	beqz	a5,acc <dispatch+0x50>
                    current_task->previous->next = current_task->next;
 ac8:	6d18                	ld	a4,24(a0)
 aca:	ef98                	sd	a4,24(a5)
                if(current_task->next != NULL){
 acc:	6d1c                	ld	a5,24(a0)
 ace:	c399                	beqz	a5,ad4 <dispatch+0x58>
                    current_task->next->previous = current_task->previous;
 ad0:	6918                	ld	a4,16(a0)
 ad2:	eb98                	sd	a4,16(a5)
                if(latest_task == current_task) latest_task = current_task->previous;
 ad4:	00000797          	auipc	a5,0x0
 ad8:	25c78793          	addi	a5,a5,604 # d30 <current_thread>
 adc:	639c                	ld	a5,0(a5)
 ade:	77d8                	ld	a4,168(a5)
 ae0:	06e50263          	beq	a0,a4,b44 <dispatch+0xc8>
                free(current_task);
 ae4:	00000097          	auipc	ra,0x0
 ae8:	c5e080e7          	jalr	-930(ra) # 742 <free>
                if(setjmp(env_tmp) == 0){
 aec:	00000517          	auipc	a0,0x0
 af0:	2cc50513          	addi	a0,a0,716 # db8 <env_tmp>
 af4:	00000097          	auipc	ra,0x0
 af8:	dba080e7          	jalr	-582(ra) # 8ae <setjmp>
 afc:	f549                	bnez	a0,a86 <dispatch+0xa>
                    current_thread->stack_p = (void *) env_tmp->sp;
 afe:	00000797          	auipc	a5,0x0
 b02:	23278793          	addi	a5,a5,562 # d30 <current_thread>
 b06:	639c                	ld	a5,0(a5)
 b08:	00000717          	auipc	a4,0x0
 b0c:	24070713          	addi	a4,a4,576 # d48 <env_st>
 b10:	6f78                	ld	a4,216(a4)
 b12:	ef98                	sd	a4,24(a5)
 b14:	bf8d                	j	a86 <dispatch+0xa>
                current_task->task_env->sp = (unsigned long) current_thread->stack_p;
 b16:	00000797          	auipc	a5,0x0
 b1a:	21278793          	addi	a5,a5,530 # d28 <current_task>
 b1e:	6388                	ld	a0,0(a5)
 b20:	00000797          	auipc	a5,0x0
 b24:	21078793          	addi	a5,a5,528 # d30 <current_thread>
 b28:	639c                	ld	a5,0(a5)
 b2a:	6f9c                	ld	a5,24(a5)
 b2c:	e55c                	sd	a5,136(a0)
                current_task->task_buf_set = 1;
 b2e:	4785                	li	a5,1
 b30:	08f52823          	sw	a5,144(a0)
                longjmp(current_task->task_env, 1);
 b34:	4585                	li	a1,1
 b36:	02050513          	addi	a0,a0,32
 b3a:	00000097          	auipc	ra,0x0
 b3e:	dac080e7          	jalr	-596(ra) # 8e6 <longjmp>
 b42:	b791                	j	a86 <dispatch+0xa>
                if(latest_task == current_task) latest_task = current_task->previous;
 b44:	6918                	ld	a4,16(a0)
 b46:	f7d8                	sd	a4,168(a5)
 b48:	bf71                	j	ae4 <dispatch+0x68>
        else longjmp(latest_task->task_env, 1);
 b4a:	4585                	li	a1,1
 b4c:	02050513          	addi	a0,a0,32
 b50:	00000097          	auipc	ra,0x0
 b54:	d96080e7          	jalr	-618(ra) # 8e6 <longjmp>
 b58:	b73d                	j	a86 <dispatch+0xa>
    current_task = NULL;
 b5a:	00000717          	auipc	a4,0x0
 b5e:	1c073723          	sd	zero,462(a4) # d28 <current_task>
    if(current_thread->buf_set == 0){
 b62:	0907a703          	lw	a4,144(a5)
 b66:	eb29                	bnez	a4,bb8 <dispatch+0x13c>
        if(setjmp(current_thread->env) == 0){
 b68:	02078513          	addi	a0,a5,32
 b6c:	00000097          	auipc	ra,0x0
 b70:	d42080e7          	jalr	-702(ra) # 8ae <setjmp>
 b74:	c10d                	beqz	a0,b96 <dispatch+0x11a>
            current_thread->fp(current_thread->arg);
 b76:	00000797          	auipc	a5,0x0
 b7a:	1ba7b783          	ld	a5,442(a5) # d30 <current_thread>
 b7e:	6398                	ld	a4,0(a5)
 b80:	6788                	ld	a0,8(a5)
 b82:	9702                	jalr	a4
            thread_exit();
 b84:	00000097          	auipc	ra,0x0
 b88:	e52080e7          	jalr	-430(ra) # 9d6 <thread_exit>
}
 b8c:	60e2                	ld	ra,24(sp)
 b8e:	6442                	ld	s0,16(sp)
 b90:	64a2                	ld	s1,8(sp)
 b92:	6105                	addi	sp,sp,32
 b94:	8082                	ret
            current_thread->env->sp = (unsigned long) current_thread->stack_p;
 b96:	00000517          	auipc	a0,0x0
 b9a:	19a53503          	ld	a0,410(a0) # d30 <current_thread>
 b9e:	6d1c                	ld	a5,24(a0)
 ba0:	e55c                	sd	a5,136(a0)
            current_thread->buf_set = 1;
 ba2:	4785                	li	a5,1
 ba4:	08f52823          	sw	a5,144(a0)
            longjmp(current_thread->env, 1);
 ba8:	4585                	li	a1,1
 baa:	02050513          	addi	a0,a0,32
 bae:	00000097          	auipc	ra,0x0
 bb2:	d38080e7          	jalr	-712(ra) # 8e6 <longjmp>
 bb6:	bfd9                	j	b8c <dispatch+0x110>
    else longjmp(current_thread->env, 1);
 bb8:	4585                	li	a1,1
 bba:	02078513          	addi	a0,a5,32
 bbe:	00000097          	auipc	ra,0x0
 bc2:	d28080e7          	jalr	-728(ra) # 8e6 <longjmp>
}
 bc6:	b7d9                	j	b8c <dispatch+0x110>

0000000000000bc8 <thread_yield>:
void thread_yield(void){
 ...
 bd4:	15853503          	ld	a0,344(a0) # d28 <current_task>
 bd8:	cd1d                	beqz	a0,c16 <thread_yield+0x4e>
        if(setjmp(current_task->task_env) == 0){
 bda:	02050513          	addi	a0,a0,32
 bde:	00000097          	auipc	ra,0x0
 be2:	cd0080e7          	jalr	-816(ra) # 8ae <setjmp>
 be6:	c509                	beqz	a0,bf0 <thread_yield+0x28>
}
 be8:	60a2                	ld	ra,8(sp)
 bea:	6402                	ld	s0,0(sp)
 ...
 bf4:	1387b783          	ld	a5,312(a5) # d28 <current_task>
 bf8:	67d8                	ld	a4,136(a5)
 bfa:	00000797          	auipc	a5,0x0
 bfe:	1367b783          	ld	a5,310(a5) # d30 <current_thread>
 c02:	ef98                	sd	a4,24(a5)
            schedule();
 c04:	00000097          	auipc	ra,0x0
 c08:	db8080e7          	jalr	-584(ra) # 9bc <schedule>
            dispatch();
 c0c:	00000097          	auipc	ra,0x0
 c10:	e70080e7          	jalr	-400(ra) # a7c <dispatch>
 c14:	bfd1                	j	be8 <thread_yield+0x20>
    else if(setjmp(current_thread->env) == 0){
 c16:	00000517          	auipc	a0,0x0
 c1a:	11a53503          	ld	a0,282(a0) # d30 <current_thread>
 c1e:	02050513          	addi	a0,a0,32
 c22:	00000097          	auipc	ra,0x0
 c26:	c8c080e7          	jalr	-884(ra) # 8ae <setjmp>
 c2a:	fd5d                	bnez	a0,be8 <thread_yield+0x20>
        current_thread->stack_p = (void *) current_thread->env->sp;
 c2c:	00000797          	auipc	a5,0x0
 c30:	1047b783          	ld	a5,260(a5) # d30 <current_thread>
 c34:	67d8                	ld	a4,136(a5)
 c36:	ef98                	sd	a4,24(a5)
        schedule();
 c38:	00000097          	auipc	ra,0x0
 c3c:	d84080e7          	jalr	-636(ra) # 9bc <schedule>
        dispatch();
 c40:	00000097          	auipc	ra,0x0
 c44:	e3c080e7          	jalr	-452(ra) # a7c <dispatch>
 c48:	b745                	j	be8 <thread_yield+0x20>

0000000000000c4a <thread_start_threading>:
void thread_start_threading(void){
 ...
 c56:	0f650513          	addi	a0,a0,246 # d48 <env_st>
 c5a:	00000097          	auipc	ra,0x0
 c5e:	c54080e7          	jalr	-940(ra) # 8ae <setjmp>
 c62:	c509                	beqz	a0,c6c <thread_start_threading+0x22>
        dispatch();
    else return;
}
 c64:	60a2                	ld	ra,8(sp)
 ...
 c70:	e10080e7          	jalr	-496(ra) # a7c <dispatch>
 c74:	bfc5                	j	c64 <thread_start_threading+0x1a>

0000000000000c76 <thread_assign_task>:
// part 2
void thread_assign_task(struct thread *t, void (*f)(void *), void *arg){
 c76:	7179                	addi	sp,sp,-48
 c78:	f406                	sd	ra,40(sp)
 c7a:	f022                	sd	s0,32(sp)
 c7c:	ec26                	sd	s1,24(sp)
 c7e:	e84a                	sd	s2,16(sp)
 c80:	e44e                	sd	s3,8(sp)
 c82:	1800                	addi	s0,sp,48
 c84:	84aa                	mv	s1,a0
 c86:	89ae                	mv	s3,a1
 c88:	8932                	mv	s2,a2
    // TODO
    struct task *new = (struct task*) malloc(sizeof(struct task));
 c8a:	09800513          	li	a0,152
 c8e:	00000097          	auipc	ra,0x0
 c92:	b3c080e7          	jalr	-1220(ra) # 7ca <malloc>
    new->fp = f;
 c96:	01353023          	sd	s3,0(a0)
    new->arg = arg;
 c9a:	01253423          	sd	s2,8(a0)
    new->task_buf_set = 0;
 c9e:	08052823          	sw	zero,144(a0)
    new->previous = t->task_tail;
 ca2:	74dc                	ld	a5,168(s1)
 ca4:	e91c                	sd	a5,16(a0)
    new->next = NULL;
 ca6:	00053c23          	sd	zero,24(a0)

    if(t->task_tail != NULL){
 caa:	74dc                	ld	a5,168(s1)
 cac:	c391                	beqz	a5,cb0 <thread_assign_task+0x3a>
        t->task_tail->next = new;
 cae:	ef88                	sd	a0,24(a5)
    }
    t->task_tail = new;
 cb0:	f4c8                	sd	a0,168(s1)
}
