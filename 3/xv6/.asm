...
void f(void *arg)
{
    ...
    while (1) {
       ...
       e:	3f678793          	addi	a5,a5,1014 # 2400 <k>
      12:	439c                	lw	a5,0(a5)
      14:	2785                	addiw	a5,a5,1
      16:	0007871b          	sext.w	a4,a5
      1a:	00002797          	auipc	a5,0x2
      1e:	3e678793          	addi	a5,a5,998 # 2400 <k>
      22:	c398                	sw	a4,0(a5)
      24:	b7dd                	j	a <f+0xa>
...
int main(int argc, char **argv)
{
    ...
    printf("\nexited\n");
      ...
      f4:	17850513          	addi	a0,a0,376 # 2268 <schedule_dm+0x222>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     702:	cc268693          	addi	a3,a3,-830 # 23c0 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     7dc:	be870713          	addi	a4,a4,-1048 # 23c0 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     99c:	8e078793          	addi	a5,a5,-1824 # 2278 <schedule_dm+0x232>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     b48:	8d478793          	addi	a5,a5,-1836 # 2418 <freep>
     b4c:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     c40:	7dc78793          	addi	a5,a5,2012 # 2418 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     cc2:	75a78793          	addi	a5,a5,1882 # 2418 <freep>
     cc6:	639c                	ld	a5,0(a5)
}
     cc8:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     cf4:	72878793          	addi	a5,a5,1832 # 2418 <freep>
     cf8:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     d08:	70478793          	addi	a5,a5,1796 # 2408 <base>
     d0c:	fef43023          	sd	a5,-32(s0)
     d10:	00001797          	auipc	a5,0x1
     d14:	70878793          	addi	a5,a5,1800 # 2418 <freep>
     d18:	fe043703          	ld	a4,-32(s0)
     d1c:	e398                	sd	a4,0(a5)
     d1e:	00001797          	auipc	a5,0x1
     d22:	6fa78793          	addi	a5,a5,1786 # 2418 <freep>
     d26:	6398                	ld	a4,0(a5)
     d28:	00001797          	auipc	a5,0x1
     d2c:	6e078793          	addi	a5,a5,1760 # 2408 <base>
     d30:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     d32:	00001797          	auipc	a5,0x1
     d36:	6d678793          	addi	a5,a5,1750 # 2408 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     db2:	66a78793          	addi	a5,a5,1642 # 2418 <freep>
    ...
    if(p == freep)
     ...
     dc8:	65478793          	addi	a5,a5,1620 # 2418 <freep>
     dcc:	639c                	ld	a5,0(a5)
...
static inline void list_del(struct list_head *entry)
{
    ...
    entry->next = LIST_POISON1;
     ...
     f50:	10070713          	addi	a4,a4,256 # 100100 <__global_pointer$+0xfd540>
     f54:	e398                	sd	a4,0(a5)
    entry->prev = LIST_POISON2;
     f56:	fe843783          	ld	a5,-24(s0)
     f5a:	00200737          	lui	a4,0x200
     f5e:	20070713          	addi	a4,a4,512 # 200200 <__global_pointer$+0x1fd640>
     f62:	e798                	sd	a4,8(a5)
}
     f64:	0001                	nop
...
void thread_add_at(struct thread *t, int arrival_time)
{
    ...
    112c:	2c058593          	addi	a1,a1,704 # 23e8 <release_queue>
    1130:	853e                	mv	a0,a5
...
void __release()
{
    ...
    1150:	29c78793          	addi	a5,a5,668 # 23e8 <release_queue>
    ...
    1184:	2a878793          	addi	a5,a5,680 # 2428 <threading_system_time>
    ...
    11c6:	21658593          	addi	a1,a1,534 # 23d8 <run_queue>
    11ca:	853e                	mv	a0,a5
    ...
    1218:	1d478793          	addi	a5,a5,468 # 23e8 <release_queue>
...
void __thread_exit(struct thread *to_remove)
{
    ...
    1242:	1e278793          	addi	a5,a5,482 # 2420 <current>
    ...
    128a:	17278793          	addi	a5,a5,370 # 23f8 <main_thrd_id>
...
void thread_exit(void)
{
    ...
    12b0:	17478793          	addi	a5,a5,372 # 2420 <current>
    12b4:	6398                	ld	a4,0(a5)
    12b6:	00001797          	auipc	a5,0x1
    12ba:	12278793          	addi	a5,a5,290 # 23d8 <run_queue>
    ...
    12c6:	fbe58593          	addi	a1,a1,-66 # 2280 <schedule_dm+0x23a>
    12ca:	4509                	li	a0,2
    ...
    12e2:	14278793          	addi	a5,a5,322 # 2420 <current>
...
void __finish_current()
{
    ...
    1358:	0cc78793          	addi	a5,a5,204 # 2420 <current>
    ...
    138a:	0a278793          	addi	a5,a5,162 # 2428 <threading_system_time>
    ...
    139e:	f1e50513          	addi	a0,a0,-226 # 22b8 <schedule_dm+0x272>
...
void __rt_finish_current()
{
    ...
    141c:	00878793          	addi	a5,a5,8 # 2420 <current>
    ...
    144e:	fde78793          	addi	a5,a5,-34 # 2428 <threading_system_time>
    ...
    1462:	e7250513          	addi	a0,a0,-398 # 22d0 <schedule_dm+0x28a>
    ...
    148a:	f9a78793          	addi	a5,a5,-102 # 2420 <current>
    148e:	639c                	ld	a5,0(a5)
    1490:	6798                	ld	a4,8(a5)
    1492:	00001797          	auipc	a5,0x1
    1496:	f8e78793          	addi	a5,a5,-114 # 2420 <current>
...
void switch_handler(void *arg)
{
    ...
    14ec:	f3878793          	addi	a5,a5,-200 # 2420 <current>
    ...
    150e:	f1e78793          	addi	a5,a5,-226 # 2428 <threading_system_time>
    ...
    1522:	f0a78793          	addi	a5,a5,-246 # 2428 <threading_system_time>
    ...
    1562:	eca78793          	addi	a5,a5,-310 # 2428 <threading_system_time>
    ...
    1576:	eb678793          	addi	a5,a5,-330 # 2428 <threading_system_time>
    ...
    1594:	e9878793          	addi	a5,a5,-360 # 2428 <threading_system_time>
    1598:	439c                	lw	a5,0(a5)
    159a:	863e                	mv	a2,a5
    159c:	85ba                	mv	a1,a4
    159e:	00001517          	auipc	a0,0x1
    15a2:	d6a50513          	addi	a0,a0,-662 # 2308 <schedule_dm+0x2c2>
    ...
    1612:	dca58593          	addi	a1,a1,-566 # 23d8 <run_queue>
    ...
    163e:	dbe78793          	addi	a5,a5,-578 # 23f8 <main_thrd_id>
...
void __dispatch()
{
    ...
    1664:	dc078793          	addi	a5,a5,-576 # 2420 <current>
    1668:	6398                	ld	a4,0(a5)
    166a:	00001797          	auipc	a5,0x1
    166e:	d6e78793          	addi	a5,a5,-658 # 23d8 <run_queue>
    ...
    167a:	daa78793          	addi	a5,a5,-598 # 2420 <current>
    ...
    169c:	d9878793          	addi	a5,a5,-616 # 2430 <allocated_time>
    ...
    16b8:	c5450513          	addi	a0,a0,-940 # 2308 <schedule_dm+0x2c2>
    ...
    16d8:	d5478793          	addi	a5,a5,-684 # 2428 <threading_system_time>
    16dc:	4390                	lw	a2,0(a5)
    16de:	00001797          	auipc	a5,0x1
    16e2:	d5278793          	addi	a5,a5,-686 # 2430 <allocated_time>
    16e6:	639c                	ld	a5,0(a5)
    16e8:	86be                	mv	a3,a5
    16ea:	85ba                	mv	a1,a4
    16ec:	00001517          	auipc	a0,0x1
    16f0:	c4450513          	addi	a0,a0,-956 # 2330 <schedule_dm+0x2ea>
    ...
    1708:	d2c78793          	addi	a5,a5,-724 # 2430 <allocated_time>
    ...
    171e:	d1678793          	addi	a5,a5,-746 # 2430 <allocated_time>
    ...
    1768:	ccc78793          	addi	a5,a5,-820 # 2430 <allocated_time>
    ...
    177e:	cb678793          	addi	a5,a5,-842 # 2430 <allocated_time>
    ...
    17a6:	bbe58593          	addi	a1,a1,-1090 # 2360 <schedule_dm+0x31a>
    17aa:	4509                	li	a0,2
...
void __schedule()
{
    ...
    17f4:	c3878793          	addi	a5,a5,-968 # 2428 <threading_system_time>
    17f8:	439c                	lw	a5,0(a5)
    17fa:	fcf42c23          	sw	a5,-40(s0)
    17fe:	4789                	li	a5,2
    1800:	fcf42e23          	sw	a5,-36(s0)
    1804:	00001797          	auipc	a5,0x1
    1808:	bd478793          	addi	a5,a5,-1068 # 23d8 <run_queue>
    180c:	fef43023          	sd	a5,-32(s0)
    1810:	00001797          	auipc	a5,0x1
    1814:	bd878793          	addi	a5,a5,-1064 # 23e8 <release_queue>
    ...
    183e:	80c080e7          	jalr	-2036(ra) # 2046 <schedule_dm>
    1842:	872a                	mv	a4,a0
    1844:	87ae                	mv	a5,a1
...
void back_to_main_handler(void *arg)
{
    ...
    1886:	baa78793          	addi	a5,a5,-1110 # 242c <sleeping>
    ...
    189a:	b9278793          	addi	a5,a5,-1134 # 2428 <threading_system_time>
    ...
    18ae:	b7e78793          	addi	a5,a5,-1154 # 2428 <threading_system_time>
    18b2:	c398                	sw	a4,0(a5)
    thrdresume(main_thrd_id);
    18b4:	00001797          	auipc	a5,0x1
    18b8:	b4478793          	addi	a5,a5,-1212 # 23f8 <main_thrd_id>
...
void thread_start_threading()
{
    ...
    18de:	b4e78793          	addi	a5,a5,-1202 # 2428 <threading_system_time>
    18e2:	0007a023          	sw	zero,0(a5)
    current = &run_queue;
    18e6:	00001797          	auipc	a5,0x1
    18ea:	b3a78793          	addi	a5,a5,-1222 # 2420 <current>
    18ee:	00001717          	auipc	a4,0x1
    18f2:	aea70713          	addi	a4,a4,-1302 # 23d8 <run_queue>
    ...
    1906:	af658593          	addi	a1,a1,-1290 # 23f8 <main_thrd_id>
    ...
    191a:	ae278793          	addi	a5,a5,-1310 # 23f8 <main_thrd_id>
    ...
    1942:	aba78793          	addi	a5,a5,-1350 # 23f8 <main_thrd_id>
    ...
    1960:	a7c50513          	addi	a0,a0,-1412 # 23d8 <run_queue>
    ...
    1974:	a7850513          	addi	a0,a0,-1416 # 23e8 <release_queue>
    ...
    1988:	aac78793          	addi	a5,a5,-1364 # 2430 <allocated_time>
    198c:	639c                	ld	a5,0(a5)
    198e:	85be                	mv	a1,a5
    1990:	00001517          	auipc	a0,0x1
    1994:	a0850513          	addi	a0,a0,-1528 # 2398 <schedule_dm+0x352>
    1998:	fffff097          	auipc	ra,0xfffff
    199c:	148080e7          	jalr	328(ra) # ae0 <printf>
        sleeping = 1;
    19a0:	00001797          	auipc	a5,0x1
    19a4:	a8c78793          	addi	a5,a5,-1396 # 242c <sleeping>
    19a8:	4705                	li	a4,1
    ...
    19b0:	a8478793          	addi	a5,a5,-1404 # 2430 <allocated_time>
    19b4:	639c                	ld	a5,0(a5)
    19b6:	0007871b          	sext.w	a4,a5
    19ba:	00001797          	auipc	a5,0x1
    19be:	a7678793          	addi	a5,a5,-1418 # 2430 <allocated_time>
    ...
    19d2:	a2a58593          	addi	a1,a1,-1494 # 23f8 <main_thrd_id>
    19d6:	853a                	mv	a0,a4
    ...
    1a06:	9e650513          	addi	a0,a0,-1562 # 23e8 <release_queue>
...
int min(int a, int b){
    ...
    1a2a:	87aa                	mv	a5,a0
    1a2c:	872e                	mv	a4,a1
    1a2e:	fef42623          	sw	a5,-20(s0)
    1a32:	87ba                	mv	a5,a4
    1a34:	fef42423          	sw	a5,-24(s0)
    return (a < b)? a:b;
    1a38:	fec42603          	lw	a2,-20(s0)
    1a3c:	fe842783          	lw	a5,-24(s0)
    1a40:	0007869b          	sext.w	a3,a5
    1a44:	0006071b          	sext.w	a4,a2
    1a48:	00d75363          	bge	a4,a3,1a4e <min+0x2a>
    1a4c:	87b2                	mv	a5,a2
    1a4e:	2781                	sext.w	a5,a5
}
    1a50:	853e                	mv	a0,a5
    1a52:	6462                	ld	s0,24(sp)
    1a54:	6105                	addi	sp,sp,32
    1a56:	8082                	ret

0000000000001a58 <schedule_default>:

/* default scheduling algorithm */
struct threads_sched_result schedule_default(struct threads_sched_args args)
{
    1a58:	715d                	addi	sp,sp,-80
    1a5a:	e4a2                	sd	s0,72(sp)
    1a5c:	e0a6                	sd	s1,64(sp)
    1a5e:	0880                	addi	s0,sp,80
    1a60:	84aa                	mv	s1,a0
    struct thread *thread_with_smallest_id = NULL;
    1a62:	fe043423          	sd	zero,-24(s0)
    struct thread *th = NULL;
    1a66:	fe043023          	sd	zero,-32(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    1a6a:	649c                	ld	a5,8(s1)
    1a6c:	639c                	ld	a5,0(a5)
    1a6e:	fcf43c23          	sd	a5,-40(s0)
    1a72:	fd843783          	ld	a5,-40(s0)
    1a76:	fd878793          	addi	a5,a5,-40
    1a7a:	fef43023          	sd	a5,-32(s0)
    1a7e:	a81d                	j	1ab4 <schedule_default+0x5c>
        if (thread_with_smallest_id == NULL || th->ID < thread_with_smallest_id->ID)
    1a80:	fe843783          	ld	a5,-24(s0)
    1a84:	cb89                	beqz	a5,1a96 <schedule_default+0x3e>
    1a86:	fe043783          	ld	a5,-32(s0)
    1a8a:	5fd8                	lw	a4,60(a5)
    1a8c:	fe843783          	ld	a5,-24(s0)
    1a90:	5fdc                	lw	a5,60(a5)
    1a92:	00f75663          	bge	a4,a5,1a9e <schedule_default+0x46>
            thread_with_smallest_id = th;
    1a96:	fe043783          	ld	a5,-32(s0)
    1a9a:	fef43423          	sd	a5,-24(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    1a9e:	fe043783          	ld	a5,-32(s0)
    1aa2:	779c                	ld	a5,40(a5)
    1aa4:	fcf43823          	sd	a5,-48(s0)
    1aa8:	fd043783          	ld	a5,-48(s0)
    1aac:	fd878793          	addi	a5,a5,-40
    1ab0:	fef43023          	sd	a5,-32(s0)
    1ab4:	fe043783          	ld	a5,-32(s0)
    1ab8:	02878713          	addi	a4,a5,40
    1abc:	649c                	ld	a5,8(s1)
    1abe:	fcf711e3          	bne	a4,a5,1a80 <schedule_default+0x28>
    }

    struct threads_sched_result r;
    if (thread_with_smallest_id != NULL) {
    1ac2:	fe843783          	ld	a5,-24(s0)
    1ac6:	cf89                	beqz	a5,1ae0 <schedule_default+0x88>
        r.scheduled_thread_list_member = &thread_with_smallest_id->thread_list;
    1ac8:	fe843783          	ld	a5,-24(s0)
    1acc:	02878793          	addi	a5,a5,40
    1ad0:	faf43823          	sd	a5,-80(s0)
        r.allocated_time = thread_with_smallest_id->remaining_time;
    1ad4:	fe843783          	ld	a5,-24(s0)
    1ad8:	4fbc                	lw	a5,88(a5)
    1ada:	faf42c23          	sw	a5,-72(s0)
    1ade:	a039                	j	1aec <schedule_default+0x94>
    } else {
        r.scheduled_thread_list_member = args.run_queue;
    1ae0:	649c                	ld	a5,8(s1)
    1ae2:	faf43823          	sd	a5,-80(s0)
        r.allocated_time = 1;
    1ae6:	4785                	li	a5,1
    1ae8:	faf42c23          	sw	a5,-72(s0)
    }

    return r;
    1aec:	fb043783          	ld	a5,-80(s0)
    1af0:	fcf43023          	sd	a5,-64(s0)
    1af4:	fb843783          	ld	a5,-72(s0)
    1af8:	fcf43423          	sd	a5,-56(s0)
    1afc:	4701                	li	a4,0
    1afe:	fc043703          	ld	a4,-64(s0)
    1b02:	4781                	li	a5,0
    1b04:	fc843783          	ld	a5,-56(s0)
    1b08:	863a                	mv	a2,a4
    1b0a:	86be                	mv	a3,a5
    1b0c:	8732                	mv	a4,a2
    1b0e:	87b6                	mv	a5,a3
    ...
    1b10:	853a                	mv	a0,a4
    1b12:	85be                	mv	a1,a5
    1b14:	6426                	ld	s0,72(sp)
    1b16:	6486                	ld	s1,64(sp)
    1b18:	6161                	addi	sp,sp,80
    1b1a:	8082                	ret

0000000000001b1c <schedule_wrr>:

/* MP3 Part 1 - Non-Real-Time Scheduling */
/* Weighted-Round-Robin Scheduling */
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    1b1c:	7159                	addi	sp,sp,-112
    1b1e:	f486                	sd	ra,104(sp)
    1b20:	f0a2                	sd	s0,96(sp)
    1b22:	eca6                	sd	s1,88(sp)
    1b24:	e8ca                	sd	s2,80(sp)
    1b26:	e4ce                	sd	s3,72(sp)
    1b28:	1880                	addi	s0,sp,112
    1b2a:	84aa                	mv	s1,a0
    //* DONE: implement the weighted round-robin scheduling algorithm
    struct thread *thread_head = NULL;
    1b2c:	fc043423          	sd	zero,-56(s0)
    struct thread *th = NULL;
    1b30:	fc043023          	sd	zero,-64(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    1b34:	649c                	ld	a5,8(s1)
    1b36:	639c                	ld	a5,0(a5)
    1b38:	faf43c23          	sd	a5,-72(s0)
    1b3c:	fb843783          	ld	a5,-72(s0)
    1b40:	fd878793          	addi	a5,a5,-40
    1b44:	fcf43023          	sd	a5,-64(s0)
    1b48:	a025                	j	1b70 <schedule_wrr+0x54>
        if (thread_head == NULL){
    1b4a:	fc843783          	ld	a5,-56(s0)
    1b4e:	e791                	bnez	a5,1b5a <schedule_wrr+0x3e>
            thread_head = th;
    1b50:	fc043783          	ld	a5,-64(s0)
    1b54:	fcf43423          	sd	a5,-56(s0)
            break;
    1b58:	a01d                	j	1b7e <schedule_wrr+0x62>
    list_for_each_entry(th, args.run_queue, thread_list) {
    1b5a:	fc043783          	ld	a5,-64(s0)
    1b5e:	779c                	ld	a5,40(a5)
    1b60:	faf43823          	sd	a5,-80(s0)
    1b64:	fb043783          	ld	a5,-80(s0)
    1b68:	fd878793          	addi	a5,a5,-40
    1b6c:	fcf43023          	sd	a5,-64(s0)
    1b70:	fc043783          	ld	a5,-64(s0)
    1b74:	02878713          	addi	a4,a5,40
    1b78:	649c                	ld	a5,8(s1)
    1b7a:	fcf718e3          	bne	a4,a5,1b4a <schedule_wrr+0x2e>
        }
    }
    ...
    1b82:	cb95                	beqz	a5,1bb6 <schedule_wrr+0x9a>
        r.scheduled_thread_list_member = &thread_head->thread_list;
    1b84:	fc843783          	ld	a5,-56(s0)
    1b88:	02878793          	addi	a5,a5,40
    1b8c:	f8f43823          	sd	a5,-112(s0)
        r.allocated_time = min(thread_head->remaining_time, thread_head->weight * 2);
    1b90:	fc843783          	ld	a5,-56(s0)
    1b94:	4fb8                	lw	a4,88(a5)
    1b96:	fc843783          	ld	a5,-56(s0)
    1b9a:	47bc                	lw	a5,72(a5)
    1b9c:	0017979b          	slliw	a5,a5,0x1
    1ba0:	2781                	sext.w	a5,a5
    1ba2:	85be                	mv	a1,a5
    1ba4:	853a                	mv	a0,a4
    1ba6:	00000097          	auipc	ra,0x0
    1baa:	e7e080e7          	jalr	-386(ra) # 1a24 <min>
    1bae:	87aa                	mv	a5,a0
    1bb0:	f8f42c23          	sw	a5,-104(s0)
    1bb4:	a039                	j	1bc2 <schedule_wrr+0xa6>
    } else {
        r.scheduled_thread_list_member = args.run_queue;
    1bb6:	649c                	ld	a5,8(s1)
    1bb8:	f8f43823          	sd	a5,-112(s0)
        r.allocated_time = 1;
    1bbc:	4785                	li	a5,1
    1bbe:	f8f42c23          	sw	a5,-104(s0)
    }
    return r;
    1bc2:	f9043783          	ld	a5,-112(s0)
    1bc6:	faf43023          	sd	a5,-96(s0)
    1bca:	f9843783          	ld	a5,-104(s0)
    1bce:	faf43423          	sd	a5,-88(s0)
    1bd2:	4701                	li	a4,0
    1bd4:	fa043703          	ld	a4,-96(s0)
    1bd8:	4781                	li	a5,0
    1bda:	fa843783          	ld	a5,-88(s0)
    1bde:	893a                	mv	s2,a4
    1be0:	89be                	mv	s3,a5
    1be2:	874a                	mv	a4,s2
    1be4:	87ce                	mv	a5,s3
    ...
    1be6:	853a                	mv	a0,a4
    1be8:	85be                	mv	a1,a5
    1bea:	70a6                	ld	ra,104(sp)
    1bec:	7406                	ld	s0,96(sp)
    1bee:	64e6                	ld	s1,88(sp)
    1bf0:	6946                	ld	s2,80(sp)
    1bf2:	69a6                	ld	s3,72(sp)
    1bf4:	6165                	addi	sp,sp,112
    1bf6:	8082                	ret

0000000000001bf8 <schedule_sjf>:

/* Shortest-Job-First Scheduling */
struct threads_sched_result schedule_sjf(struct threads_sched_args args)
{
    1bf8:	7119                	addi	sp,sp,-128
    1bfa:	fca2                	sd	s0,120(sp)
    1bfc:	f8a6                	sd	s1,112(sp)
    1bfe:	0100                	addi	s0,sp,128
    1c00:	84aa                	mv	s1,a0
    //* DONE: implement the shortest-job-first scheduling algorithm
    struct thread *thread_shortest = NULL;
    1c02:	fe043423          	sd	zero,-24(s0)
    struct thread *th = NULL;
    1c06:	fe043023          	sd	zero,-32(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    1c0a:	649c                	ld	a5,8(s1)
    1c0c:	639c                	ld	a5,0(a5)
    1c0e:	fcf43023          	sd	a5,-64(s0)
    1c12:	fc043783          	ld	a5,-64(s0)
    1c16:	fd878793          	addi	a5,a5,-40
    1c1a:	fef43023          	sd	a5,-32(s0)
    1c1e:	a899                	j	1c74 <schedule_sjf+0x7c>
        if (thread_shortest == NULL || th->remaining_time < thread_shortest->remaining_time\
    1c20:	fe843783          	ld	a5,-24(s0)
    1c24:	cb8d                	beqz	a5,1c56 <schedule_sjf+0x5e>
    1c26:	fe043783          	ld	a5,-32(s0)
    1c2a:	4fb8                	lw	a4,88(a5)
    1c2c:	fe843783          	ld	a5,-24(s0)
    1c30:	4fbc                	lw	a5,88(a5)
    1c32:	02f74263          	blt	a4,a5,1c56 <schedule_sjf+0x5e>
    ...
    1c40:	4fbc                	lw	a5,88(a5)
    1c42:	00f71e63          	bne	a4,a5,1c5e <schedule_sjf+0x66>
    1c46:	fe043783          	ld	a5,-32(s0)
    1c4a:	5fd8                	lw	a4,60(a5)
    1c4c:	fe843783          	ld	a5,-24(s0)
    1c50:	5fdc                	lw	a5,60(a5)
    1c52:	00f75663          	bge	a4,a5,1c5e <schedule_sjf+0x66>
            thread_shortest = th;
    1c56:	fe043783          	ld	a5,-32(s0)
    1c5a:	fef43423          	sd	a5,-24(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    1c5e:	fe043783          	ld	a5,-32(s0)
    1c62:	779c                	ld	a5,40(a5)
    1c64:	faf43023          	sd	a5,-96(s0)
    1c68:	fa043783          	ld	a5,-96(s0)
    1c6c:	fd878793          	addi	a5,a5,-40
    1c70:	fef43023          	sd	a5,-32(s0)
    1c74:	fe043783          	ld	a5,-32(s0)
    1c78:	02878713          	addi	a4,a5,40
    1c7c:	649c                	ld	a5,8(s1)
    1c7e:	faf711e3          	bne	a4,a5,1c20 <schedule_sjf+0x28>
    }

    struct release_queue_entry *cur, *nxt;
    int a_time = thread_shortest->remaining_time;
    1c82:	fe843783          	ld	a5,-24(s0)
    1c86:	4fbc                	lw	a5,88(a5)
    1c88:	fcf42623          	sw	a5,-52(s0)
    list_for_each_entry_safe(cur, nxt, args.release_queue, thread_list) { 
    1c8c:	689c                	ld	a5,16(s1)
    1c8e:	639c                	ld	a5,0(a5)
    1c90:	faf43c23          	sd	a5,-72(s0)
    1c94:	fb843783          	ld	a5,-72(s0)
    1c98:	17e1                	addi	a5,a5,-8
    1c9a:	fcf43c23          	sd	a5,-40(s0)
    1c9e:	fd843783          	ld	a5,-40(s0)
    1ca2:	679c                	ld	a5,8(a5)
    1ca4:	faf43823          	sd	a5,-80(s0)
    1ca8:	fb043783          	ld	a5,-80(s0)
    1cac:	17e1                	addi	a5,a5,-8
    1cae:	fcf43823          	sd	a5,-48(s0)
    1cb2:	a04d                	j	1d54 <schedule_sjf+0x15c>
        if(cur->release_time < args.current_time + a_time\
    1cb4:	fd843783          	ld	a5,-40(s0)
    1cb8:	4f8c                	lw	a1,24(a5)
    1cba:	409c                	lw	a5,0(s1)
    1cbc:	fcc42703          	lw	a4,-52(s0)
    1cc0:	9fb9                	addw	a5,a5,a4
    1cc2:	2781                	sext.w	a5,a5
    1cc4:	872e                	mv	a4,a1
    1cc6:	06f75963          	bge	a4,a5,1d38 <schedule_sjf+0x140>
            && (cur->release_time + cur->thrd->processing_time < args.current_time + thread_shortest->remaining_time\
    1cca:	fd843783          	ld	a5,-40(s0)
    1cce:	4f98                	lw	a4,24(a5)
    1cd0:	fd843783          	ld	a5,-40(s0)
    1cd4:	639c                	ld	a5,0(a5)
    1cd6:	43fc                	lw	a5,68(a5)
    1cd8:	9fb9                	addw	a5,a5,a4
    1cda:	0007859b          	sext.w	a1,a5
    1cde:	4098                	lw	a4,0(s1)
    1ce0:	fe843783          	ld	a5,-24(s0)
    1ce4:	4fbc                	lw	a5,88(a5)
    1ce6:	9fb9                	addw	a5,a5,a4
    1ce8:	2781                	sext.w	a5,a5
    1cea:	872e                	mv	a4,a1
    1cec:	02f74e63          	blt	a4,a5,1d28 <schedule_sjf+0x130>
                || (cur->release_time + cur->thrd->processing_time == args.current_time + thread_shortest->remaining_time\
    1cf0:	fd843783          	ld	a5,-40(s0)
    1cf4:	4f98                	lw	a4,24(a5)
    1cf6:	fd843783          	ld	a5,-40(s0)
    1cfa:	639c                	ld	a5,0(a5)
    1cfc:	43fc                	lw	a5,68(a5)
    1cfe:	9fb9                	addw	a5,a5,a4
    1d00:	0007859b          	sext.w	a1,a5
    1d04:	4098                	lw	a4,0(s1)
    1d06:	fe843783          	ld	a5,-24(s0)
    1d0a:	4fbc                	lw	a5,88(a5)
    1d0c:	9fb9                	addw	a5,a5,a4
    1d0e:	2781                	sext.w	a5,a5
    1d10:	872e                	mv	a4,a1
    1d12:	02f71363          	bne	a4,a5,1d38 <schedule_sjf+0x140>
                && cur->thrd->ID < thread_shortest->ID))){ 
    1d16:	fd843783          	ld	a5,-40(s0)
    1d1a:	639c                	ld	a5,0(a5)
    1d1c:	5fd8                	lw	a4,60(a5)
    1d1e:	fe843783          	ld	a5,-24(s0)
    1d22:	5fdc                	lw	a5,60(a5)
    1d24:	00f75a63          	bge	a4,a5,1d38 <schedule_sjf+0x140>
            a_time = cur->release_time - args.current_time;
    1d28:	fd843783          	ld	a5,-40(s0)
    1d2c:	4f98                	lw	a4,24(a5)
    1d2e:	409c                	lw	a5,0(s1)
    1d30:	40f707bb          	subw	a5,a4,a5
    1d34:	fcf42623          	sw	a5,-52(s0)
    list_for_each_entry_safe(cur, nxt, args.release_queue, thread_list) { 
    1d38:	fd043783          	ld	a5,-48(s0)
    1d3c:	fcf43c23          	sd	a5,-40(s0)
    1d40:	fd043783          	ld	a5,-48(s0)
    1d44:	679c                	ld	a5,8(a5)
    1d46:	faf43423          	sd	a5,-88(s0)
    1d4a:	fa843783          	ld	a5,-88(s0)
    1d4e:	17e1                	addi	a5,a5,-8
    1d50:	fcf43823          	sd	a5,-48(s0)
    1d54:	fd843783          	ld	a5,-40(s0)
    1d58:	00878713          	addi	a4,a5,8
    1d5c:	689c                	ld	a5,16(s1)
    1d5e:	f4f71be3          	bne	a4,a5,1cb4 <schedule_sjf+0xbc>
        }
    }

    struct threads_sched_result r;
    if (thread_shortest != NULL) {
    1d62:	fe843783          	ld	a5,-24(s0)
    1d66:	cf81                	beqz	a5,1d7e <schedule_sjf+0x186>
        r.scheduled_thread_list_member = &thread_shortest->thread_list;
    1d68:	fe843783          	ld	a5,-24(s0)
    1d6c:	02878793          	addi	a5,a5,40
    1d70:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = a_time;
    1d74:	fcc42783          	lw	a5,-52(s0)
    1d78:	f8f42423          	sw	a5,-120(s0)
    1d7c:	a039                	j	1d8a <schedule_sjf+0x192>
    } else {
        r.scheduled_thread_list_member = args.run_queue;
    1d7e:	649c                	ld	a5,8(s1)
    1d80:	f8f43023          	sd	a5,-128(s0)
        r.allocated_time = 1;
    1d84:	4785                	li	a5,1
    1d86:	f8f42423          	sw	a5,-120(s0)
    }
    return r;
    1d8a:	f8043783          	ld	a5,-128(s0)
    1d8e:	f8f43823          	sd	a5,-112(s0)
    1d92:	f8843783          	ld	a5,-120(s0)
    1d96:	f8f43c23          	sd	a5,-104(s0)
    1d9a:	4701                	li	a4,0
    1d9c:	f9043703          	ld	a4,-112(s0)
    1da0:	4781                	li	a5,0
    1da2:	f9843783          	ld	a5,-104(s0)
    1da6:	863a                	mv	a2,a4
    1da8:	86be                	mv	a3,a5
    1daa:	8732                	mv	a4,a2
    1dac:	87b6                	mv	a5,a3
    ...
    1dae:	853a                	mv	a0,a4
    1db0:	85be                	mv	a1,a5
    1db2:	7466                	ld	s0,120(sp)
    1db4:	74c6                	ld	s1,112(sp)
    1db6:	6109                	addi	sp,sp,128
    1db8:	8082                	ret

0000000000001dba <schedule_lst>:
...
{
    1dba:	7131                	addi	sp,sp,-192
    1dbc:	fd06                	sd	ra,184(sp)
    1dbe:	f922                	sd	s0,176(sp)
    1dc0:	f526                	sd	s1,168(sp)
    1dc2:	f14a                	sd	s2,160(sp)
    1dc4:	ed4e                	sd	s3,152(sp)
    1dc6:	0180                	addi	s0,sp,192
    1dc8:	84aa                	mv	s1,a0
    int least_slack_time = -1;
    1dca:	57fd                	li	a5,-1
    1dcc:	fcf42623          	sw	a5,-52(s0)
    struct thread *thread_with_least_slack = NULL;
    1dd0:	fc043023          	sd	zero,-64(s0)
    struct thread *th = NULL;
    1dd4:	fa043c23          	sd	zero,-72(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    1dd8:	649c                	ld	a5,8(s1)
    1dda:	639c                	ld	a5,0(a5)
    1ddc:	f8f43c23          	sd	a5,-104(s0)
    1de0:	f9843783          	ld	a5,-104(s0)
    1de4:	fd878793          	addi	a5,a5,-40
    1de8:	faf43c23          	sd	a5,-72(s0)
    1dec:	a8b5                	j	1e68 <schedule_lst+0xae>
        int slack_time = th->current_deadline - args.current_time - th->remaining_time;
    1dee:	fb843783          	ld	a5,-72(s0)
    1df2:	4ff8                	lw	a4,92(a5)
    1df4:	409c                	lw	a5,0(s1)
    1df6:	40f707bb          	subw	a5,a4,a5
    1dfa:	0007871b          	sext.w	a4,a5
    1dfe:	fb843783          	ld	a5,-72(s0)
    1e02:	4fbc                	lw	a5,88(a5)
    1e04:	40f707bb          	subw	a5,a4,a5
    1e08:	f6f42a23          	sw	a5,-140(s0)
    ...
    1e10:	cb8d                	beqz	a5,1e42 <schedule_lst+0x88>
    1e12:	f7442703          	lw	a4,-140(s0)
    1e16:	fcc42783          	lw	a5,-52(s0)
    1e1a:	2701                	sext.w	a4,a4
    1e1c:	2781                	sext.w	a5,a5
    1e1e:	02f74263          	blt	a4,a5,1e42 <schedule_lst+0x88>
    1e22:	f7442703          	lw	a4,-140(s0)
    1e26:	fcc42783          	lw	a5,-52(s0)
    1e2a:	2701                	sext.w	a4,a4
    1e2c:	2781                	sext.w	a5,a5
    1e2e:	02f71263          	bne	a4,a5,1e52 <schedule_lst+0x98>
    1e32:	fb843783          	ld	a5,-72(s0)
    1e36:	5fd8                	lw	a4,60(a5)
    1e38:	fc043783          	ld	a5,-64(s0)
    1e3c:	5fdc                	lw	a5,60(a5)
    1e3e:	00f75a63          	bge	a4,a5,1e52 <schedule_lst+0x98>
            least_slack_time = slack_time;
    1e42:	f7442783          	lw	a5,-140(s0)
    1e46:	fcf42623          	sw	a5,-52(s0)
            thread_with_least_slack = th;
    1e4a:	fb843783          	ld	a5,-72(s0)
    1e4e:	fcf43023          	sd	a5,-64(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    1e52:	fb843783          	ld	a5,-72(s0)
    1e56:	779c                	ld	a5,40(a5)
    1e58:	f6f43423          	sd	a5,-152(s0)
    1e5c:	f6843783          	ld	a5,-152(s0)
    1e60:	fd878793          	addi	a5,a5,-40
    1e64:	faf43c23          	sd	a5,-72(s0)
    1e68:	fb843783          	ld	a5,-72(s0)
    1e6c:	02878713          	addi	a4,a5,40
    1e70:	649c                	ld	a5,8(s1)
    1e72:	f6f71ee3          	bne	a4,a5,1dee <schedule_lst+0x34>
        }
    }

    int next_release = -1,\
    1e76:	57fd                	li	a5,-1
    1e78:	faf42a23          	sw	a5,-76(s0)
    ...
    1e80:	4ff8                	lw	a4,92(a5)
    1e82:	409c                	lw	a5,0(s1)
    1e84:	40f707bb          	subw	a5,a4,a5
    1e88:	0007871b          	sext.w	a4,a5
    1e8c:	fc043783          	ld	a5,-64(s0)
    1e90:	4fbc                	lw	a5,88(a5)
    1e92:	85be                	mv	a1,a5
    1e94:	853a                	mv	a0,a4
    1e96:	00000097          	auipc	ra,0x0
    1e9a:	b8e080e7          	jalr	-1138(ra) # 1a24 <min>
    1e9e:	87aa                	mv	a5,a0
    1ea0:	faf42823          	sw	a5,-80(s0)
    th = NULL;
    1ea4:	fa043c23          	sd	zero,-72(s0)
    struct release_queue_entry *cur, *nxt;
    list_for_each_entry_safe(cur, nxt, args.release_queue, thread_list) { 
    1ea8:	689c                	ld	a5,16(s1)
    1eaa:	639c                	ld	a5,0(a5)
    1eac:	f8f43823          	sd	a5,-112(s0)
    1eb0:	f9043783          	ld	a5,-112(s0)
    1eb4:	17e1                	addi	a5,a5,-8
    1eb6:	faf43423          	sd	a5,-88(s0)
    1eba:	fa843783          	ld	a5,-88(s0)
    1ebe:	679c                	ld	a5,8(a5)
    1ec0:	f8f43423          	sd	a5,-120(s0)
    1ec4:	f8843783          	ld	a5,-120(s0)
    1ec8:	17e1                	addi	a5,a5,-8
    1eca:	faf43023          	sd	a5,-96(s0)
    1ece:	a229                	j	1fd8 <schedule_lst+0x21e>
        if(next_release == -1 || cur->release_time - args.current_time < next_release){ 
    1ed0:	fb442783          	lw	a5,-76(s0)
    1ed4:	0007871b          	sext.w	a4,a5
    1ed8:	57fd                	li	a5,-1
    1eda:	00f70f63          	beq	a4,a5,1ef8 <schedule_lst+0x13e>
    1ede:	fa843783          	ld	a5,-88(s0)
    1ee2:	4f98                	lw	a4,24(a5)
    1ee4:	409c                	lw	a5,0(s1)
    1ee6:	40f707bb          	subw	a5,a4,a5
    1eea:	0007871b          	sext.w	a4,a5
    1eee:	fb442783          	lw	a5,-76(s0)
    1ef2:	2781                	sext.w	a5,a5
    1ef4:	00f75a63          	bge	a4,a5,1f08 <schedule_lst+0x14e>
            next_release = cur->release_time - args.current_time;
    1ef8:	fa843783          	ld	a5,-88(s0)
    1efc:	4f98                	lw	a4,24(a5)
    1efe:	409c                	lw	a5,0(s1)
    1f00:	40f707bb          	subw	a5,a4,a5
    1f04:	faf42a23          	sw	a5,-76(s0)
        }
        int cur_slack = cur->thrd->current_deadline - cur->release_time - cur->thrd->remaining_time,\
    1f08:	fa843783          	ld	a5,-88(s0)
    1f0c:	639c                	ld	a5,0(a5)
    1f0e:	4ff8                	lw	a4,92(a5)
    1f10:	fa843783          	ld	a5,-88(s0)
    1f14:	4f9c                	lw	a5,24(a5)
    1f16:	40f707bb          	subw	a5,a4,a5
    1f1a:	0007871b          	sext.w	a4,a5
    1f1e:	fa843783          	ld	a5,-88(s0)
    1f22:	639c                	ld	a5,0(a5)
    1f24:	4fbc                	lw	a5,88(a5)
    1f26:	40f707bb          	subw	a5,a4,a5
    1f2a:	f8f42223          	sw	a5,-124(s0)
    ...
    1f2e:	fc043783          	ld	a5,-64(s0)
    1f32:	4ff8                	lw	a4,92(a5)
    1f34:	fa843783          	ld	a5,-88(s0)
    1f38:	4f9c                	lw	a5,24(a5)
    1f3a:	40f707bb          	subw	a5,a4,a5
    1f3e:	0007871b          	sext.w	a4,a5
    1f42:	fc043783          	ld	a5,-64(s0)
    1f46:	4fb4                	lw	a3,88(a5)
    1f48:	fa843783          	ld	a5,-88(s0)
    1f4c:	4f90                	lw	a2,24(a5)
    1f4e:	409c                	lw	a5,0(s1)
    1f50:	40f607bb          	subw	a5,a2,a5
    1f54:	2781                	sext.w	a5,a5
    1f56:	40f687bb          	subw	a5,a3,a5
    1f5a:	2781                	sext.w	a5,a5
    1f5c:	40f707bb          	subw	a5,a4,a5
    1f60:	f8f42023          	sw	a5,-128(s0)
        if(cur->release_time < args.current_time + a_time\
    1f64:	fa843783          	ld	a5,-88(s0)
    1f68:	4f94                	lw	a3,24(a5)
    1f6a:	409c                	lw	a5,0(s1)
    1f6c:	fb042703          	lw	a4,-80(s0)
    1f70:	9fb9                	addw	a5,a5,a4
    1f72:	2781                	sext.w	a5,a5
    1f74:	8736                	mv	a4,a3
    1f76:	04f75363          	bge	a4,a5,1fbc <schedule_lst+0x202>
        && (cur_slack < tmp_slack || (cur_slack == tmp_slack && cur->thrd->ID < thread_with_least_slack->ID))){ 
    1f7a:	f8442703          	lw	a4,-124(s0)
    1f7e:	f8042783          	lw	a5,-128(s0)
    1f82:	2701                	sext.w	a4,a4
    1f84:	2781                	sext.w	a5,a5
    1f86:	02f74363          	blt	a4,a5,1fac <schedule_lst+0x1f2>
    1f8a:	f8442703          	lw	a4,-124(s0)
    1f8e:	f8042783          	lw	a5,-128(s0)
    1f92:	2701                	sext.w	a4,a4
    1f94:	2781                	sext.w	a5,a5
    1f96:	02f71363          	bne	a4,a5,1fbc <schedule_lst+0x202>
    1f9a:	fa843783          	ld	a5,-88(s0)
    1f9e:	639c                	ld	a5,0(a5)
    1fa0:	5fd8                	lw	a4,60(a5)
    1fa2:	fc043783          	ld	a5,-64(s0)
    1fa6:	5fdc                	lw	a5,60(a5)
    1fa8:	00f75a63          	bge	a4,a5,1fbc <schedule_lst+0x202>
            a_time = cur->release_time - args.current_time;
    1fac:	fa843783          	ld	a5,-88(s0)
    1fb0:	4f98                	lw	a4,24(a5)
    1fb2:	409c                	lw	a5,0(s1)
    1fb4:	40f707bb          	subw	a5,a4,a5
    1fb8:	faf42823          	sw	a5,-80(s0)
    list_for_each_entry_safe(cur, nxt, args.release_queue, thread_list) { 
    1fbc:	fa043783          	ld	a5,-96(s0)
    1fc0:	faf43423          	sd	a5,-88(s0)
    1fc4:	fa043783          	ld	a5,-96(s0)
    1fc8:	679c                	ld	a5,8(a5)
    1fca:	f6f43c23          	sd	a5,-136(s0)
    1fce:	f7843783          	ld	a5,-136(s0)
    1fd2:	17e1                	addi	a5,a5,-8
    1fd4:	faf43023          	sd	a5,-96(s0)
    1fd8:	fa843783          	ld	a5,-88(s0)
    1fdc:	00878713          	addi	a4,a5,8
    1fe0:	689c                	ld	a5,16(s1)
    1fe2:	eef717e3          	bne	a4,a5,1ed0 <schedule_lst+0x116>
        }
    }

    struct threads_sched_result r;
    if (thread_with_least_slack != NULL) {
    1fe6:	fc043783          	ld	a5,-64(s0)
    1fea:	cf81                	beqz	a5,2002 <schedule_lst+0x248>
        r.scheduled_thread_list_member = &thread_with_least_slack->thread_list;
    1fec:	fc043783          	ld	a5,-64(s0)
    1ff0:	02878793          	addi	a5,a5,40
    1ff4:	f4f43423          	sd	a5,-184(s0)
        r.allocated_time = a_time;
    1ff8:	fb042783          	lw	a5,-80(s0)
    1ffc:	f4f42823          	sw	a5,-176(s0)
    2000:	a801                	j	2010 <schedule_lst+0x256>
        // printf("%d, %d\n", thread_with_least_slack->current_deadline - args.current_time, thread_with_least_slack->remaining_time);
    } else {
        r.scheduled_thread_list_member = args.run_queue;
    2002:	649c                	ld	a5,8(s1)
    2004:	f4f43423          	sd	a5,-184(s0)
        r.allocated_time = next_release; 
    2008:	fb442783          	lw	a5,-76(s0)
    200c:	f4f42823          	sw	a5,-176(s0)
    }
    return r;
    2010:	f4843783          	ld	a5,-184(s0)
    2014:	f4f43c23          	sd	a5,-168(s0)
    2018:	f5043783          	ld	a5,-176(s0)
    201c:	f6f43023          	sd	a5,-160(s0)
    2020:	4701                	li	a4,0
    2022:	f5843703          	ld	a4,-168(s0)
    2026:	4781                	li	a5,0
    2028:	f6043783          	ld	a5,-160(s0)
    202c:	893a                	mv	s2,a4
    202e:	89be                	mv	s3,a5
    2030:	874a                	mv	a4,s2
    2032:	87ce                	mv	a5,s3
    ...
    2034:	853a                	mv	a0,a4
    2036:	85be                	mv	a1,a5
    2038:	70ea                	ld	ra,184(sp)
    203a:	744a                	ld	s0,176(sp)
    203c:	74aa                	ld	s1,168(sp)
    203e:	790a                	ld	s2,160(sp)
    2040:	69ea                	ld	s3,152(sp)
    2042:	6129                	addi	sp,sp,192
    2044:	8082                	ret

0000000000002046 <schedule_dm>:


/* Deadline-Monotonic Scheduling */
struct threads_sched_result schedule_dm(struct threads_sched_args args)
{
    2046:	7135                	addi	sp,sp,-160
    2048:	ed06                	sd	ra,152(sp)
    204a:	e922                	sd	s0,144(sp)
    204c:	e526                	sd	s1,136(sp)
    204e:	e14a                	sd	s2,128(sp)
    2050:	fcce                	sd	s3,120(sp)
    2052:	1100                	addi	s0,sp,160
    2054:	84aa                	mv	s1,a0
    // TODO: implement the deadline-monotonic scheduling algorithm
    struct thread *thread_ddl = NULL;
    2056:	fc043423          	sd	zero,-56(s0)
    struct thread *th = NULL;
    205a:	fc043023          	sd	zero,-64(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    205e:	649c                	ld	a5,8(s1)
    2060:	639c                	ld	a5,0(a5)
    2062:	faf43023          	sd	a5,-96(s0)
    2066:	fa043783          	ld	a5,-96(s0)
    206a:	fd878793          	addi	a5,a5,-40
    206e:	fcf43023          	sd	a5,-64(s0)
    2072:	a899                	j	20c8 <schedule_dm+0x82>
    ...
    2078:	cb8d                	beqz	a5,20aa <schedule_dm+0x64>
    207a:	fc043783          	ld	a5,-64(s0)
    207e:	47f8                	lw	a4,76(a5)
    2080:	fc843783          	ld	a5,-56(s0)
    2084:	47fc                	lw	a5,76(a5)
    2086:	02f74263          	blt	a4,a5,20aa <schedule_dm+0x64>
    208a:	fc043783          	ld	a5,-64(s0)
    208e:	47f8                	lw	a4,76(a5)
    2090:	fc843783          	ld	a5,-56(s0)
    2094:	47fc                	lw	a5,76(a5)
    2096:	00f71e63          	bne	a4,a5,20b2 <schedule_dm+0x6c>
    209a:	fc043783          	ld	a5,-64(s0)
    209e:	5fd8                	lw	a4,60(a5)
    20a0:	fc843783          	ld	a5,-56(s0)
    20a4:	5fdc                	lw	a5,60(a5)
    20a6:	00f75663          	bge	a4,a5,20b2 <schedule_dm+0x6c>
            thread_ddl = th;
    20aa:	fc043783          	ld	a5,-64(s0)
    20ae:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(th, args.run_queue, thread_list) {
    20b2:	fc043783          	ld	a5,-64(s0)
    20b6:	779c                	ld	a5,40(a5)
    20b8:	f8f43023          	sd	a5,-128(s0)
    20bc:	f8043783          	ld	a5,-128(s0)
    20c0:	fd878793          	addi	a5,a5,-40
    20c4:	fcf43023          	sd	a5,-64(s0)
    20c8:	fc043783          	ld	a5,-64(s0)
    20cc:	02878713          	addi	a4,a5,40
    20d0:	649c                	ld	a5,8(s1)
    20d2:	faf711e3          	bne	a4,a5,2074 <schedule_dm+0x2e>
    }

    int next_release = -1,\
    20d6:	57fd                	li	a5,-1
    20d8:	faf42e23          	sw	a5,-68(s0)
        a_time = min(thread_ddl->current_deadline - args.current_time, thread_ddl->remaining_time);
    20dc:	fc843783          	ld	a5,-56(s0)
    20e0:	4ff8                	lw	a4,92(a5)
    20e2:	409c                	lw	a5,0(s1)
    20e4:	40f707bb          	subw	a5,a4,a5
    20e8:	0007871b          	sext.w	a4,a5
    20ec:	fc843783          	ld	a5,-56(s0)
    20f0:	4fbc                	lw	a5,88(a5)
    20f2:	85be                	mv	a1,a5
    20f4:	853a                	mv	a0,a4
    20f6:	00000097          	auipc	ra,0x0
    20fa:	92e080e7          	jalr	-1746(ra) # 1a24 <min>
    20fe:	87aa                	mv	a5,a0
    2100:	faf42c23          	sw	a5,-72(s0)
    th = NULL;
    ...
    210c:	f8f43c23          	sd	a5,-104(s0)
    2110:	f9843783          	ld	a5,-104(s0)
    2114:	17e1                	addi	a5,a5,-8
    2116:	faf43823          	sd	a5,-80(s0)
    211a:	fb043783          	ld	a5,-80(s0)
    211e:	679c                	ld	a5,8(a5)
    2120:	f8f43823          	sd	a5,-112(s0)
    2124:	f9043783          	ld	a5,-112(s0)
    2128:	17e1                	addi	a5,a5,-8
    212a:	faf43423          	sd	a5,-88(s0)
    212e:	a84d                	j	21e0 <schedule_dm+0x19a>
        if(next_release == -1 || cur->release_time - args.current_time < next_release){ 
    2130:	fbc42783          	lw	a5,-68(s0)
    2134:	0007871b          	sext.w	a4,a5
    2138:	57fd                	li	a5,-1
    213a:	00f70f63          	beq	a4,a5,2158 <schedule_dm+0x112>
    213e:	fb043783          	ld	a5,-80(s0)
    2142:	4f98                	lw	a4,24(a5)
    2144:	409c                	lw	a5,0(s1)
    2146:	40f707bb          	subw	a5,a4,a5
    214a:	0007871b          	sext.w	a4,a5
    214e:	fbc42783          	lw	a5,-68(s0)
    2152:	2781                	sext.w	a5,a5
    2154:	00f75a63          	bge	a4,a5,2168 <schedule_dm+0x122>
            next_release = cur->release_time - args.current_time;
    2158:	fb043783          	ld	a5,-80(s0)
    215c:	4f98                	lw	a4,24(a5)
    215e:	409c                	lw	a5,0(s1)
    2160:	40f707bb          	subw	a5,a4,a5
    2164:	faf42e23          	sw	a5,-68(s0)
        }
        // printf("cur   #%d ddl = %d\n", cur->thrd->ID, cur->thrd->deadline);
        // printf("thddl #%d ddl = %d\n\n\n", thread_ddl->ID, thread_ddl->deadline);
        if(cur->release_time < args.current_time + a_time\
    2168:	fb043783          	ld	a5,-80(s0)
    216c:	4f94                	lw	a3,24(a5)
    216e:	409c                	lw	a5,0(s1)
    2170:	fb842703          	lw	a4,-72(s0)
    2174:	9fb9                	addw	a5,a5,a4
    2176:	2781                	sext.w	a5,a5
    2178:	8736                	mv	a4,a3
    217a:	04f75563          	bge	a4,a5,21c4 <schedule_dm+0x17e>
        && (cur->thrd->deadline < thread_ddl->deadline || (cur->thrd->deadline == thread_ddl->deadline && cur->thrd->ID < thread_ddl->ID))){ 
    217e:	fb043783          	ld	a5,-80(s0)
    2182:	639c                	ld	a5,0(a5)
    2184:	47f8                	lw	a4,76(a5)
    2186:	fc843783          	ld	a5,-56(s0)
    218a:	47fc                	lw	a5,76(a5)
    218c:	02f74463          	blt	a4,a5,21b4 <schedule_dm+0x16e>
    2190:	fb043783          	ld	a5,-80(s0)
    2194:	639c                	ld	a5,0(a5)
    2196:	47f8                	lw	a4,76(a5)
    2198:	fc843783          	ld	a5,-56(s0)
    219c:	47fc                	lw	a5,76(a5)
    219e:	02f71363          	bne	a4,a5,21c4 <schedule_dm+0x17e>
    21a2:	fb043783          	ld	a5,-80(s0)
    21a6:	639c                	ld	a5,0(a5)
    21a8:	5fd8                	lw	a4,60(a5)
    21aa:	fc843783          	ld	a5,-56(s0)
    21ae:	5fdc                	lw	a5,60(a5)
    21b0:	00f75a63          	bge	a4,a5,21c4 <schedule_dm+0x17e>
            a_time = cur->release_time - args.current_time;
    21b4:	fb043783          	ld	a5,-80(s0)
    21b8:	4f98                	lw	a4,24(a5)
    21ba:	409c                	lw	a5,0(s1)
    21bc:	40f707bb          	subw	a5,a4,a5
    21c0:	faf42c23          	sw	a5,-72(s0)
    list_for_each_entry_safe(cur, nxt, args.release_queue, thread_list) { 
    21c4:	fa843783          	ld	a5,-88(s0)
    21c8:	faf43823          	sd	a5,-80(s0)
    21cc:	fa843783          	ld	a5,-88(s0)
    21d0:	679c                	ld	a5,8(a5)
    21d2:	f8f43423          	sd	a5,-120(s0)
    21d6:	f8843783          	ld	a5,-120(s0)
    21da:	17e1                	addi	a5,a5,-8
    21dc:	faf43423          	sd	a5,-88(s0)
    21e0:	fb043783          	ld	a5,-80(s0)
    21e4:	00878713          	addi	a4,a5,8
    21e8:	689c                	ld	a5,16(s1)
    21ea:	f4f713e3          	bne	a4,a5,2130 <schedule_dm+0xea>
        }
    }

    if(thread_ddl->current_deadline - args.current_time <= 0) a_time = 0;
    21ee:	fc843783          	ld	a5,-56(s0)
    21f2:	4ff8                	lw	a4,92(a5)
    21f4:	409c                	lw	a5,0(s1)
    21f6:	40f707bb          	subw	a5,a4,a5
    21fa:	2781                	sext.w	a5,a5
    21fc:	00f04463          	bgtz	a5,2204 <schedule_dm+0x1be>
    2200:	fa042c23          	sw	zero,-72(s0)

    struct threads_sched_result r;
    if (thread_ddl != NULL) {
    2204:	fc843783          	ld	a5,-56(s0)
    2208:	cf81                	beqz	a5,2220 <schedule_dm+0x1da>
        r.scheduled_thread_list_member = &thread_ddl->thread_list;
    220a:	fc843783          	ld	a5,-56(s0)
    220e:	02878793          	addi	a5,a5,40
    2212:	f6f43023          	sd	a5,-160(s0)
        r.allocated_time = a_time;
    2216:	fb842783          	lw	a5,-72(s0)
    221a:	f6f42423          	sw	a5,-152(s0)
    221e:	a801                	j	222e <schedule_dm+0x1e8>
    } else {
        r.scheduled_thread_list_member = args.run_queue;
    2220:	649c                	ld	a5,8(s1)
    2222:	f6f43023          	sd	a5,-160(s0)
        r.allocated_time = next_release;
    2226:	fbc42783          	lw	a5,-68(s0)
    222a:	f6f42423          	sw	a5,-152(s0)
    }
    return r;
    222e:	f6043783          	ld	a5,-160(s0)
    2232:	f6f43823          	sd	a5,-144(s0)
    2236:	f6843783          	ld	a5,-152(s0)
    223a:	f6f43c23          	sd	a5,-136(s0)
    223e:	4701                	li	a4,0
    2240:	f7043703          	ld	a4,-144(s0)
    2244:	4781                	li	a5,0
    2246:	f7843783          	ld	a5,-136(s0)
    224a:	893a                	mv	s2,a4
    224c:	89be                	mv	s3,a5
    224e:	874a                	mv	a4,s2
    2250:	87ce                	mv	a5,s3
    ...
    2252:	853a                	mv	a0,a4
    2254:	85be                	mv	a1,a5
    2256:	60ea                	ld	ra,152(sp)
    2258:	644a                	ld	s0,144(sp)
    225a:	64aa                	ld	s1,136(sp)
    225c:	690a                	ld	s2,128(sp)
    225e:	79e6                	ld	s3,120(sp)
    2260:	610d                	addi	sp,sp,160
    2262:	8082                	ret
